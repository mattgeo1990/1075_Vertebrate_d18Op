...
## Procedure 1: Monte Carlo on simulated data, dual-taxon temperature reconstruction
- Summary:
...
Barrick et al. (1999) equation for ambient water:

$$$\delta$^18^O~ambient_water~ = 1.01$\delta$^18^O~phosphate~ -23$$
!!! Toubleshoot lines 215, 223, then generate d18Oaw !!!
```{r, results='hide', message=FALSE, warning=FALSE}
